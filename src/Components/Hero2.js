  ...
  return (
    <div className="bg-[rgba(22,5,48,1)] text-center py-16 max-w-full h-[600px]">
      ...
      <div className='flex justify-between mx-auto max-w-[90%] gap-3 mt-20'>
        <div className='flex flex-col bg-purple-800 rounded-3xl max-w-[300px] p-4' data-aos="fade-down">
          <span className='text-black text-[25px] font-bold'>Step 1 :</span>
          <span className='text-black text-[25px] font-bold'>Evaluation</span>
        ...
        <div className='flex flex-col bg-purple-800 rounded-3xl max-w-[300px] p-4' data-aos="fade-up">
          <span className='text-black text-[25px] font-bold'>Step 2:</span>
          <span className='text-black text-[25px] font-bold'>Risk Verification</span>
          <span className='text-black text-[25px] font-bold'>Verification</span>
        ...
        <div className='flex flex-col bg-purple-800 rounded-3xl max-w-[300px] p-4' data-aos="fade-down">
          <span className='text-black text-[25px] font-bold'>Step 3 :</span>
          <span className='text-black text-[25px] font-bold'>Monetized Training</span>
          <span className='text-black text-[25px] font-bold'>Training</span>
        ...
        <div className='flex flex-col bg-purple-800 rounded-3xl max-w-[300px] p-4' data-aos="fade-up">
          <span className='text-black text-[25px] font-bold'>Step 4 :</span>
          <span className='text-black text-[25px] font-bold'>Manage Hedge</span>
            <span className='text-black text-[25px] font-bold'>Fund Capital</span>
